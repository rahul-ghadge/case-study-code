...
//        System.out.println(country);
        ...
        for (int i = 0; i < noOfRecords; i++) {
            ...
            UserData user = UserData.builder()
                    ...
                    .url("www.shop.com/" + action + "/item=" + ITEMS.get(new Random().nextInt(ITEMS.size())))
                    .paymentMethod(action.equals("Purchase") ? PAYMENTS.get(new Random().nextInt(PAYMENTS.size())) : "NA")
